...
namespace BasicLogicalPrograms
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (!IsExitProgram)
            {
                Console.WriteLine("Choose 1.FlipCoin 2.CheckleapYear 3.PowerOfTwo 4.HarmonicNumber 5.PrimeFactors 6.QuotientandRemainder 7.SwapOfTwoNumbers 8:CheckEvenOrOdd 9.CheckVowelOrConsonat 10.LargestAmongThreeNumbers 11.ExitProgram");
